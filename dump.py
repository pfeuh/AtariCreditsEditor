...
if __name__ == "__main__":
    ...
    sys.stdout.write(dump([x for x in range(123)]))
    sys.stdout.write(dump([x for x in range(123)], 16))
    sys.stdout.write(dump([x for x in range(65, 80)], 1))
